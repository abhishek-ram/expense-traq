...
urlpatterns = media_url + [
    ...
    url(r'^expense/mark-paid/$',
        login_required(views.ExpenseMarkPaid.as_view()),
    ...
    url(r'^expense/(?P<pk>[0-9]+)/edit/$',
        ...
        name='expense-update'),
    url(r'^expense/(?P<pk>[0-9]+)/delete/$',
        login_required(views.ExpenseDelete.as_view()),
        name='expense-delete'),
    ...
    url(r'^regions/$',
        login_required(views.RegionList.as_view()),
        name='region-list'),
    url(r'^region/add/$',
        login_required(views.RegionCreate.as_view()),
        name='region-add'),
    url(r'^region/(?P<pk>[0-9]+)/edit/$',
        login_required(views.RegionUpdate.as_view()),
        name='region-update'),
    url(r'^region/(?P<pk>[0-9]+)/delete/$',
        login_required(views.RegionDelete.as_view()),
        name='region-delete'),
